...
void file_compress    OF((char  *file, char *mode, int *brs_input, int brs_input_len, int *brs_secret, int brs_secret_len));
 ...
 * original.
 */
void file_compress(file, mode, brs_input, brs_input_len, brs_secret, brs_secret_len)
    char  *file;
    char  *mode;
    int   *brs_input;
    int    brs_input_len;
    ...
    int    brs_secret_len;
{
    ...
    z_stream *strm = &(out->strm);
    // z_stream *strm = &(((gz_statep)out)->strm);
    append_all_brs(strm, brs_input, brs_input_len, brs_secret, brs_secret_len);
